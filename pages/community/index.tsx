  ...
  return (
    <div className="py-16 px-4 space-y-8">
      {Array.from({ length: 6 }, (_, i) => i).map((index) => (
        <div className="flex flex-col items-start cursor-pointer" key={index}>
          <span className="flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
            동네질문
          </span>
          <div className="mt-2 text-gray-700">
            <span className="text-orange-400 font-midium">Q.</span> What is the
      ...
      <button className="fixed bottom-14 right-4 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 cursor-pointer transition-colors">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
