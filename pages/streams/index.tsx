  ...
  return (
    <Layout title="라이브" hasTabBar>
      <section className="space-y-6 divide-y-2">
        ...
        <button className="fixed bottom-24 right-4 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 cursor-pointer transition-colors border-transparent">
          <svg
