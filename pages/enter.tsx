            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  type="number"
                  required
                  className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-r-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-400 focus:border-orange-400"
                />
              </div>
            ) : null}
          </div>
