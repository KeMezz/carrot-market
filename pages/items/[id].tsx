      ...
      <div className="mb-8">
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center justify-between mt-5 space-x-2">
            <button className="flex-1 bg-orange-400 text-white py-3 rounded-md shadow-md hover:bg-orange-600 font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400">
              Talk to seller
            </button>
